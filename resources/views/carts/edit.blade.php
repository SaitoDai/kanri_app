                ...
                <tr>
                  <form action="{{ route('carts.update', $cart->cartDetail) }}" method="post">
                    ...
                    <td class="d-flex align-items-center">
                      <input class="input-quantity form-control w-50 text-end" type="number" name="quantity" value="{{ $cart->cartDetail->quantity }}" />
                      <div class="text-nowrap">&ensp;/&ensp;{{ $cart->cartDetail->itemDetail->quantity }}</div>
                    </td>
